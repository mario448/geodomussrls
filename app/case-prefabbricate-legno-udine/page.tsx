...
export default function WoodHomesPage() {
  return (
    <ServicePage
      ...
      problemText="Una casa prefabbricata in legno funziona quando struttura, involucro e impianti nascono insieme. Se fotovoltaico, biomasse, accumulo e locali tecnici vengono decisi dopo la progettazione architettonica, il rischio è adattare soluzioni costose a un edificio che non le aveva previste."
      ...
      whenNotSense={["Il terreno non è ancora verificato dal punto di vista urbanistico o geologico", "Il progetto architettonico è già chiuso senza predisposizioni impiantistiche", "Si confrontano offerte solo sul prezzo al metro quadro senza capitolato tecnico", "Il budget non considera fondazioni, impianti, finiture, pratiche e sistemazioni esterne"]}
